...
public class A4 extends Activity {
    ...
    private View.OnClickListener btn1_click=new View.OnClickListener(){
        ...
        public void onClick(View v) {
            ...
            Intent intent=new Intent(Intent.ACTION_VIEW,Uri.parse("http://edu.deltamoocx.net/"));
    ...
    private View.OnClickListener btn3_click=new View.OnClickListener(){
        ...
        public void onClick(View v) {
            ...
            Intent intent=new Intent(Intent.ACTION_VIEW,Uri.parse("https://market.cloud.edu.tw/senior"));
            startActivity(intent);
